...
pub const CLIENT_URL: &'static str = "https://api.devnet.solana.com";
...
impl NftClient {
    pub fn new() -> Self {
        ...
        let commitment_config = CommitmentConfig::committed();

        NftClient {
            client: RpcClient::new_with_commitment(url, commitment_config)
        }
    }
}
...
pub fn create_metadata_account(
    ...
    let uri = String::from("https://magiceden.com");
